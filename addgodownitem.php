...
{
    $sql="INSERT INTO godown_inventory (itemcord, type, itemunique, quantity) VALUES ( '".$_POST['sno']."', '".$_POST['type']."', '".$_POST['sno'].$_POST['type']."', '".$_POST['qty']."' )";
    //$a=1;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add New Godown Item</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">New Item For Godown</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
